...
async function refreshFiles(filePaths = []) {
    try {
...
async function waitForDotnetAnalysisComplete(timeoutMs = 30000) {
...
async function refreshProject(filePaths) {
    try {
...
async function gotoSymbolDefinition(filePath, line, character) {
    try {
